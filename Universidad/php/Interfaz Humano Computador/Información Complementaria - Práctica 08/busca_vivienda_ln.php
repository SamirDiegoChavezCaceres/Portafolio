...
<HEAD>
   <TITLE>B�squeda de vivienda</TITLE>
...
mysqli_select_db ($conexion, "lindavista1")
   ...
   // Consulta
      ...
      else if (!$sql = procesa_consulta ($consulta, $conexion))
      {
...
// Si los datos son correctos, procesar formulario
   ...
   {
      print("<P>Resultados de la b�squeda:</P>\n");
